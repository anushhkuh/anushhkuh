...
📄 [Resume](https://green-bertina-71.tiiny.site) &nbsp;|&nbsp; 💼 [LinkedIn](https://www.linkedin.com/in/anushkatiwariasu/) &nbsp;|&nbsp; 📬 atiwar55@asu.edu
...
![AWS](https://img.shields.io/badge/AWS_CCP-232F3E?style=flat&logo=amazonaws&logoColor=white)
...
**AI Research Intern @ ASU SCAI Lab** (Jan 2026 – Present)
- Autonomous vehicle trajectory prediction using the **Waymo Open Dataset**
- CNN-LSTM and Transformer models in PyTorch; 15% accuracy improvement over naive baseline
- Built visualization tools with OpenCV and Matplotlib for model diagnostics
